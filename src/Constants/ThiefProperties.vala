...
namespace ThiefMD {
    public class ThiefProperties : Object {
        ...
        public const string SUPPORTED_IMPORT_FILES = "*.docx;*.odt;*.html;*.tex;*.epub;*.textile;*.html;*.fb2;*.dbk;*.xml;*.opml;*.rst;*.md;*.markdown;*.fountain;*.fou;*.spmd;*.textpack;*.highland;*.bear2bk;";
